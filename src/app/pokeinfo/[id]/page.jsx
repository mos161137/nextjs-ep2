            ...
            <div className='shadow-md p-10 rounded-md'>
                {loading ? (
                    ...
                    <>
                        ...
                        <Image src={poke.sprites?.other.home.front_shiny|| `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/${poke.id}.png`} width={300} height={300} alt={poke?.name||'pokemon'} />
                        <div className='mt-5'>
